    ...
    public partial class alltables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaymentsMethod", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsMetroBit = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginalTimeSlotId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_AppointmentsStatus_StatusId",
                        column: x => x.StatusId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Appointments_TimeSlots_OriginalTimeSlotId",
                        column: x => x.OriginalTimeSlotId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Appointments_Users_RescheduledByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DoctorHospitals_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorsAvailability", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorsSpecialization", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DoctorsSpecialization_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DoctorsSpecialization_Specializations_SpecializationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Payments_PaymentsStatus_PaymentStatusId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_OriginalTimeSlotId",
                table: "Appointments",
                column: "OriginalTimeSlotId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_RescheduledByUserId",
                table: "Appointments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorHospitals_DepartmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorsSpecialization_DoctorId",
                table: "DoctorsSpecialization",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_DoctorsSpecialization_SpecializationId",
                table: "DoctorsSpecialization",
